...
class CreateUserSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        //Brief Permissions
        $Brief1 = Permission::create(['name' => 'Brief-Create','guard_name' => 'web']);
        $Brief2 = Permission::create(['name' => 'Brief-Edit','guard_name' => 'web']);
        $Brief3 = Permission::create(['name' => 'Brief-View','guard_name' => 'web']);
        $Brief4 = Permission::create(['name' => 'Brief-Delete','guard_name' => 'web']);
        ...
        $adminRole->givePermissionTo([$Brief1, $Brief2, $Brief3, $Brief4]);
