                ...
                <form id="payment-form" class="needs-validation">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-md-12">
                            <input type="text" class="form-control cardNo" inputmode="numeric" pattern="[0-9\s]{13,19}" name="cardNo" maxlength="19" id="cardNo" placeholder="Card Number">
                            <span class="validation-error text-danger d-none"></span>
                            <div class="invalid-feedback">
                        ...
                        <div class="col-lg-5 col-md-12 d-flex">
                            <div class="col-lg-4 col-md-4">
                                <input type="number" maxlength="2" class="form-control month" id="month" name="month" placeholder="MM">
                                <span class="validation-error text-danger d-none"></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <input type="number" maxlength="4" class="form-control year" id="year" name="year" placeholder="YYYY">
                                <span class="validation-error text-danger d-none"></span>
                                <div class="invalid-feedback">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <input type="number" maxlength="4" class="form-control cvc" id="cvc" name="cvc" placeholder="CVC">
                                <span class="validation-error text-danger d-none"></span>
                                <div class="invalid-feedback">
                                    CVC is required.
                                </div>
