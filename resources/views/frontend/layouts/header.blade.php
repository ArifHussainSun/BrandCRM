        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 d-flex align-items-center">
                    <a href="{{ route('front.home') }}" class="logo"><img src="{{ asset($brand_settings['logo']) }}"></a>
                </div>
                ...
                @if(!empty($brand_settings["company_number"]))
                    <div class="col-md-2 d-flex align-items-center">
                        <a href="tel:{{ $brand_settings['company_number'] }}" class="phone-1"><i class="fas fa-phone phone"></i>{{ $brand_settings["company_number"] }}</a>
                    </div>
                @endif
            </div>
        </div>
            ...
            <div class="col-12 d-flex justify-content-start">
                <div class="custom-collapse">
                    <ul>
                        ...
                        @if(!empty($brand_settings["company_number"]))
                            <li><a href="tel:{{ $brand_settings['company_number'] }}" class="phone-1"><i class="fas fa-phone phone"></i>{{ $brand_settings['company_number'] }}</a></li>
                        @endif
                    </ul>
                </div>
            </div>
