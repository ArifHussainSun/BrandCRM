...
@php
$product_bundles = App\Models\ProductBundles::where('sub_categories_id', $subcategory->id)->where('active',1)->with('category','Subcategory')->get();
@endphp
...
@forelse($products as $product)
                ...
                $products_subcategory = $product_bundle->Subcategory->name;
