    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card-body">
                ...
                <hr>
                <table id="faq" class="table table-bordered table-condensed table-striped" style="font-size: small;">
