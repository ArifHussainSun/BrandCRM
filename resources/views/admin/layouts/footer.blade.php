...
// Alert Close
    setTimeout(() => {
        $(document).find('.alert-close').trigger('click');
    }, 3000);
    ...
    function showMsg(type, message) {
        $(document).find('.alert-message').html('<div class="alert alert-' + type + ' alert-dismissible fade show" role="alert"><i class="mdi mdi-check-all me-2"></i>' + message + '<button type="button" class="btn-close alert-close" data-bs-dismiss="alert" aria-label="Close"></button></div>');
    }
