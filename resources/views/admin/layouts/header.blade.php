        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ (!empty($brand_settings['logo_white']) ? asset($brand_settings['logo_white']) : asset('backend/assets/images/users/logo.png')) }}" style="width: 40%;height:40%;">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($user->image) ? asset($user->image) : asset('backend/assets/images/default/no-image.jpg') ) }}" alt="Header Avatar">
