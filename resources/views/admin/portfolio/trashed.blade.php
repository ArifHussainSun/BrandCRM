                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="orderdetailsModalLabel">    View Portfolio</h5>
 ...
 <script>
    ...
    $(document).ready(function() {
        ...
        var table = $('#portfolio').DataTable({
                ajax: route('portfolio.list.trashed'),
                serverSide: true,
                processing: true,
                aaSorting:[[0,"desc"]],
                columns: [
        ...
        $(document).on('click','.btn-view',function(){
            ...
            $.ajax({
                url: route('portfolio.detail.view','yes'),
                type: "post",
