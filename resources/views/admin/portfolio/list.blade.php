        ...
        <div class="card">
            <div class="card-body">
                <h3>
                    ...
                    <a href="{{route('portfolio.add')}}" class="btn btn-xs btn-success float-right add">ADD PORTFOLIO</a>
                    <a href="{{ route('portfolio.list') }}" class="btn btn-xs btn-primary">ALL PORTFOLIO</a>
                    <a href="{{ route('portfolio.list.trashed') }}" class="btn btn-xs btn-danger">TRASH</a>
                    @endcan
                </h3>
                <hr>
                <table id="portfolio" class="table table-bordered table-condensed table-striped" style="font-size: small;">
                    <thead>
                        <tr>
                            <th>Id</th>
                            <th>Name</th>
                ...
                <div class="modal fade portfoliodetailsModal" id="modal" tabindex="-1" role="dialog" aria-labelledby="portfoliodetailsModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="portfoliodetailsModalLabel"> View Portfolio</h5>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.viewModal', function(event) {
            ...
            $.ajax({
                url: route('portfolio.detail.view', id),
                type: "post",
                data: {
                    id: id
                },
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    form.find('input[name="portfoliolink"]').val(data.portfoliolink)
                    ...
                    $('input[name="portfoliolink"]').removeAttr('readonly');
            ...
            modal.find('.modal-title').text('Update portfolios')
            ...
            form.find('input[name="portfoliolink"]').val(rowData.portfoliolink)
    ...
    $(document).on('change', '.portfolio_status', function(e) {
