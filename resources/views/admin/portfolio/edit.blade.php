                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control select2" name="sub_categories_id" id="sub_categories">
                                                ...
                                                <option value="{{ $subcategory->id }}" {{ $portfolio->sub_categories_id == $subcategory->id  ? 'selected' : ''}} >{{ $subcategory->name }}</option>
                                                @empty
                                                @endforelse
                                            </select>
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body" style="margin-top: 2%">
                                        <label for="popup" class="control-label">Pop Image</label>
                            ...
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="text" class="form-control" name="video_link" id="video_link" value="{{$portfolio->video_link}}" placeholder="Enter Video Link here">                                            
