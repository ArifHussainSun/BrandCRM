        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('product.store.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-8">
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" class="form-control" name="price" id="horizontal-price-input" placeholder="Enter Price">
                                        ...
                                        <div class="col-sm-12">
                                            <select class="form-control select2" name="currency" id="currency">
                                                ...
                                                @forelse($currencies as $currency)
                                                    <option value="{{ $currency->id }}" {{ ($currency->currency_name == 'US Dollar' ? "selected" : "") }}>{{ $currency->currency_name }} ({{ $currency->currency_symbol }})</option>
                                                  @empty
                                                @endforelse
                                            </select>
                                ...
                                <div class="row">
                                     <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-12">
                                            <input type="number" class="form-control" name="discount" id="discount" placeholder="Enter Discount Price here">
