        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{route('product-bundle.store.update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <strong><label for="products" class="col-sm-6 col-form-label">Product</label></strong>
                                    ...
                                    <div class="col-sm-6">
                                        <strong><label for="sub_categories" class="col-sm-3 col-form-label">Sub Category</label></strong>
