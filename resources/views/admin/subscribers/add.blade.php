...
@section('container')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">ADD NEW SUBSCRIBERS</h4>
                    ...
                    @endif
                    <form action="{{ route('subscriber.store.update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"  class="form-control" placeholder="Enter Phone Number here" name="phone" id="horizontal-phone-input">
                                    @if ($errors->has('phone'))
