                            ...
                            <form class="form" action="" method="POST" enctype="multipart/form-data" >
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            <label for="pages_header">Page Header</label>
                                            <input type="text" name="pages_header" id="pages_header" class="form-control input-sm">
                                        </div>
                                        <div class="form-group">
                                            <label for="content"> Page Content</label>
                                            <input type="text" name="pages_content" id="pages_content" class="form-control input-sm">
                                        </div>
                                        <div class="form-group">
                                            <label for="footer">Page footer</label>
                                            <input type="text" name="pages_footer" id="pages_footer" class="form-control input-sm">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="meta_title" id="meta_title" class="form-control input-sm" >
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_description">Meta Description</label>
                                            <input type="text" name="meta_description" id="meta_description" class="form-control input-sm" >
                                        </div>
                                        <div class="form-group">
                                            <label for="meta_keyword">Meta Keyword</label>
                                            <input type="text" name="meta_keyword" id="meta_keyword" class="form-control input-sm" >
                                        </div>
