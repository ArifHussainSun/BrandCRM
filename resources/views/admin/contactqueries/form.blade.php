...
@section('container')
    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title mb-4">Add New Contact Message</h4>
                    ...
                    @endif
                    <form action="{{route('contact-queries.store.update')}}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="email" class="form-control" name="email" id="horizontal-email-input" placeholder="Enter Email here">
                                    @if ($errors->has('email'))
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="subject" class="form-control" name="subject" id="subject" placeholder="Enter Subject here">
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"  class="form-control" placeholder="Enter Data here" name="data"  id="horizontal-data-input">
                                    @if ($errors->has('data'))
                        ...
                        <div class="row">
                            ...
                            <strong><label for="horizontal-short_address-input" class="col-sm-3 col-form-label">Message</label></strong>
                                <div class="col-sm-12">
                                    <textarea type="text" rows="4" class="form-control" placeholder="Enter Message here" name="message" id="summernote"></textarea>
