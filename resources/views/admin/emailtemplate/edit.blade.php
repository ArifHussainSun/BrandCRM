        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('emailtemplate.store.update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <div class="col-sm-12">
                                                    <!-- <input type="from" class="form-control" placeholder="Enter Form here"
                                                        ...
                                                        @forelse($mailes as $mail)
                                                            ...
                                                            <option value="{{  $mails->mail_smtp_email }}" {{ $emailtemplate->from == $mails->mail_smtp_email ? 'selected' : '' }}>{{ $mails->mail_smtp_email }}</option>
                                                            @empty
                                                        @endforelse
                                                    </select>
                                                    @if ($errors->has('from'))
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="form-control" placeholder="Enter Content here" name="content" id="summernote">{{ !empty($emailtemplate->content) ? $emailtemplate->content : '' }}</textarea>
