                    ...
                    <form id="paymentlink_form">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" class="form-control" name="item_name" id="item_name" placeholder="Enter Item Name here" value="{{ old('item_name') }}">
                        ...
                        <div class="row">
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" placeholder="Enter Price here" name="price" id="price" value="{{ old('price') }}">
                                    <span class="validation-error text-danger d-none"></span>
                                    @if ($errors->has('price'))
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-12">
                                    <input type="number" class="form-control" placeholder="Enter Discount here" name="discount" id="discount" value="{{ old('discount') }}">
                                    <span class="validation-error text-danger d-none"></span>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12" style="text-align: center;">
                                    <button type="submit" class="btn btn-primary w-md generate">GENERATE</button>
                                </div>
                            </div>
                        </div>
                    </form>
