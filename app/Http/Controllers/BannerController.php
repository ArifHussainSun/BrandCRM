...
class BannerController extends Controller
{
    ...
    public function storeOrUpdate(Request $request)
    {
        ...
        if ($valid) {
            $banner = Banner::findOrNew($request->id);
            $isNewBanner = $banner->id == null;
            ...
            $data = array(
                "success" => true,
                "message" => $isNewBanner ? "Banner Added Successfully" : "Banner Updated Successfully"
            );
            ...
            if ($banner->save()) {
                ...
                $banner->touch();
                $notifyKey = $isNewBanner ? 'added' : 'updated';
                $notify = array(
                    "performed_by" => $user_id,
                    "title" => $isNewBanner ? "Added New Banner" : "Banner Updated Successfully",
                    "desc" => array(
                        $notifyKey.'_title' => $request->input('heading_one'),
                ...
                $data["success"] = false;
                $data["message"] = $isNewBanner ? "Banner Not Added Successfully." : "Banner Not Updated Successfully.";
    ...
    public function restore(Request $request, $id)
    {
        ...
        $success = $banner->restore();

        $response = [
            "success" => $success,
            "message" => $success ? "Banner Restored Successfully!" : "Failed to Restore Banner!"
        ];
    ...
    public function destroy(Request $request)
    {
        ...
        $success = $banner->forceDelete();
        $response = [
            "success" => $success,
            "message" => $banner->trashed() ? "Banner Destroy Successfully!" : "Failed to Destroy Banner!"
        ];
