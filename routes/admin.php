...
Route::middleware(['auth'])->group(function () {
    ...
    Route::controller(ContactqueriesController::class)->group(function () {
        ...
        Route::post('/contact-queries/save', 'storeOrUpdate')->name('contact-queries.store.update');
    ...
    Route::controller(CategoriesController::class)->group(function () {
        ...
        Route::post('/category/save', 'storeOrUpdate')->name('categories.store.update');
    ...
    Route::controller(SubCategoriesController::class)->group(function () {
        ...
        Route::post('/sub-category/save', 'storeOrUpdate')->name('sub-category.store.update');
    ...
    Route::controller(ProductController::class)->group(function () {
        ...
        Route::post('/product/save', 'storeOrUpdate')->name('product.store.update');
    ...
    Route::controller(ProductBundlesController::class)->group(function () {
        ...
        Route::post('/product-bundle/save', 'storeOrUpdate')->name('product-bundle.store.update');
    ...
    Route::controller(PagesController::class)->group(function () {
        ...
        Route::post('/page/save', 'storeOrUpdate')->name('page.store.update');
    ...
    Route::controller(TestimonialController::class)->group(function () {
        ...
        Route::post('testimonial/save', 'storeOrUpdate')->name('testimonial.store.update');
    ...
    Route::controller(FaqController::class)->group(function () {
        ...
        Route::post('/faq/save', 'storeOrUpdate')->name('faq.store.update');
    ...
    Route::controller(PartnerController::class)->group(function () {
        ...
        Route::post('/partner/save', 'storeOrUpdate')->name('partner.store.update');
    ...
    Route::controller(GalleryController::class)->group(function () {
        ...
        Route::post('gallery/save', 'storeOrUpdate')->name('gallery.store.update');
    ...
    Route::controller(BannerController::class)->group(function () {
        ...
        Route::post('/banner/save', 'storeOrUpdate')->name('banner.store.update');
    ...
    Route::controller(SubscriberController::class)->group(function () {
        ...
        Route::post('/subscriber/save', 'storeOrUpdate')->name('subscriber.store.update');
    ...
    Route::controller(PaymentsController::class)->group(function () {
        ...
        Route::post('/payment/save', 'storeOrUpdate')->name('payment.store.update');
        ...
        Route::any('/payment/send/invoice', 'sendInvoice')->name('payment.send.invoice');
    ...
    Route::controller(CustomerController::class)->group(function () {
        ...
        Route::post('customer/save', 'storeOrUpdate')->name('customer.store.update');
    ...
    Route::controller(CouponController::class)->group(function () {
        ...
        Route::post('coupon/save', 'storeOrUpdate')->name('coupon.store.update');
    ...
    Route::controller(PaymentLinkController::class)->group(function () {
        ...
        Route::post('/payment-link-generator/save', 'storeOrUpdate')->name('payment-link-generator.store.update');
    ...
    Route::controller(EmailTemplateController::class)->group(function () {
        ...
        Route::post('email/save', 'storeOrUpdate')->name('emailtemplate.store.update');
    ...
    Route::controller(ServiceController::class)->group(function () {
        ...
        Route::post('/service/save', 'storeOrUpdate')->name('service.store.update');
    ...
    Route::controller(PortfolioController::class)->group(function () {
        ...
        Route::post('/portfolio/save','storeOrUpdate')->name('portfolio.store.update');
